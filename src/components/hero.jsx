          ...
          <div className="grid grid-cols-4 gap-10  px-6 w-full ">
            {/* Kota Faculty Card */}
              ...
              <Card className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300">
                ...
                <h2 className="text-xl font-medium mb-3">Kota Faculty</h2>
            ...
            {/* Proven Results Card */}
              ...
              <Card className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300">
                ...
                <h2 className="text-xl font-medium mb-3">Proven Results</h2>
                <p className="text-sm text-gray-600 text-left">
            ...
            {/* Learning Tools Card */}
              ...
              <Card className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300">
                ...
                <h2 className="text-xl font-medium mb-3">Learning Tools</h2>
                <p className="text-sm text-gray-600 text-left">
            ...
            {/* Mentor Support Card */}
              ...
              <Card className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300">
                ...
                <h2 className="text-xl font-medium mb-3">Mentor Support</h2>
                <p className="text-sm text-gray-600 text-left">
